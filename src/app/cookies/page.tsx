    ...
    <LegalDocument title="Политика использования файлов cookie" updatedAt="27 августа 2026 г.">
      ...
      <LegalSection title="3. Какие cookie и технологии мы используем">
        ...
        <p>
          ...
          улучшения продукта после согласия Пользователя. На Сервисе подключена{" "}
      ...
      <LegalSection title="5. Как управлять cookie">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            принять все cookie или оставить только необходимые через уведомление на сайте;
          </li>
          <li>
            изменить выбор позже по ссылке «Настройки cookie» в подвале сайта;
          </li>
      ...
      <LegalSection title="6. Согласие">
        <p>
          При первом посещении Сервис показывает уведомление о cookie. Технические cookie,
          необходимые для работы сайта, используются для обеспечения базовых функций Сервиса.
          Аналитические cookie и Яндекс.Метрика включаются только после нажатия «Принять».
        </p>
        <p>
          Выбор «Только нужные» сохраняет работу сайта без аналитики. Выбор можно изменить через
          ссылку «Настройки cookie».
        </p>
        <p>
