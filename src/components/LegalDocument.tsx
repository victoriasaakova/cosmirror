    ...
    <main className="min-h-full bg-[#050d4a] text-[#f4efe8]">
      <div className="mx-auto max-w-3xl px-5 pb-20 pt-10 md:px-8 md:pt-14">
        ...
        <header className="mt-10 border-b border-white/10 pb-8">
          <p className="font-display text-lg text-white/50">Cosmirror</p>
          <h1 className="mt-3 font-display text-3xl leading-tight tracking-tight text-white md:text-4xl">
            {title}
          </h1>
          <p className="mt-3 text-sm text-white/40">Дата публикации: {updatedAt}</p>
        </header>

        <div className="legal-prose mt-10 space-y-8 text-[15px] font-light leading-relaxed text-white/70 md:text-base">
          {children}
        </div>
